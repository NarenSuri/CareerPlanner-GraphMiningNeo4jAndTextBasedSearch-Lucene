...
AticlesPath = "C:/Users/nsuri/Desktop/IndependentStudy/Data/WikiPageData/articles/wiki_articles/"  ## list of All content files folder # dont change this

file_path_ForWikiIdMapping= "C:/Users/nsuri/Desktop/IndependentStudy/Data/article/SplitFiles/long-v2/"  ######### change this
#file_nameForWikiIdMapping= "C:/Users/nsuri/Desktop/IndependentStudy/Data/article/articles/articles.txt"

outputFilename = "C:/Users/nsuri/Desktop/IndependentStudy/Data/ProcessWikiDataForTopicModeling/WikiTopicModelInputComplete.txt"
missingFilename = "C:/Users/nsuri/Desktop/IndependentStudy/Data/ProcessWikiDataForTopicModeling/WikiMissingPagesDuplicated.txt"
...
def startDataPreparation(output_file,notFound_files,loadedDataDf):
    global fileNamesDictionary
    #global loadedDataDf
    global onlyfiles
...
def MappingWikiIDAndFileNames(file_nameForWikiIdMapping):
    global fileNamesDictionary
...
def starting():
    try: 
        ...
        ####################################
        ## Call this and load all the files ; this should be used all along for the entire processing   
        
        ####################################
        ### load and process each articles divided file     
        for Splitted_Article_File in listdir(file_path_ForWikiIdMapping):
            global fileNamesDictionary
            fileNamesDictionary={}
            MappingWikiIDAndFileNames(file_path_ForWikiIdMapping+Splitted_Article_File)
            for Splitted_Results_File in listdir(path):
                #global loadedDataDf                
                excelsheet = panda.ExcelFile(path+Splitted_Results_File)
                print(excelsheet.sheet_names)
                print(excelsheet.sheet_names[0])
                loadedDataDf = excelsheet.parse(excelsheet.sheet_names[0])
                startDataPreparation(output_file,notFound_files,loadedDataDf)
                loadedDataDf = loadedDataDf[0:0]
